...
use aws_sdk_bedrock::operation::invoke_model::InvokeModelError;
use aws_sdk_bedrock::operation::invoke_model::InvokeModelOutput;
...
use aws_sdk_sagemaker::operation::invoke_endpoint::InvokeEndpointError;
use aws_sdk_sagemaker::operation::invoke_endpoint::InvokeEndpointOutput;
...
type InvokeModelRequest = aws_sdk_bedrock::operation::invoke_model::builders::InvokeModelFluentBuilder;
type InvokeEndpointRequest = aws_sdk_sagemaker::operation::invoke_endpoint::builders::InvokeEndpointFluentBuilder;
